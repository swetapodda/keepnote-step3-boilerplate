...
1. Clone the base boilerplate in the folder **assignment-solution-step3** of your local machine
    ...
    `git clone https://gitlab-ibm.stackroute.in/stack_java_keep_v2/KeepNote-Step3-Boilerplate.git assignment-solution-step3`
...
5. Add your new repository reference as remote
     ...
     `git remote add origin https://gitlab-ibm.stackroute.in/{{yourUserName}}/assignment-solution-step3.git`
